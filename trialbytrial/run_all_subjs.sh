...
models_long='zz mostleast_voter feedbackRL feedbackRL_correctalso logfeedbackRL logfeedbackRL_1alpha feedbackRL_nocontrib feedbackRL_nocontrib_1alpha feedbackRL_oppcontrib feedbackRL_oppcontrib_1alpha feedbackRL_recencyprimacy feedbackRL_recencyprimacy_sameweight feedbackRL_1alpha_recencyprimacy feedbackRL_1alpha_recencyprimacy_sameweight mostleast_multiplier mostP_multiplier most2_multiplier least2_multiplier zz'
models_longlong=''
if [ -z "$models" ]; then
