...
models_long='zz mostleast_voter feedbackRL feedbackRL_correctalso logfeedbackRL feedbackRL_recencyprimacy feedbackRL_recencyprimacy_sameweight feedbackRL_1alpha_recencyprimacy feedbackRL_1alpha_recencyprimacy_sameweight zz'
models_longlong=''
if [ -z "$models" ]; then
